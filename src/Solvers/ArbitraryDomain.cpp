...
void ArbitraryDomain::LoadFile() {
    ...
    if(num_meshes != 1)
        cout << "cannot handle more or less than one mesh!!" << endl;

    h5_id_t mesh_id = 0;
    h5err = H5FedOpenMesh(f, mesh_id, TRIANGLE_MESH);
