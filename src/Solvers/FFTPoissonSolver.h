...
public:
  ...
  FFTPoissonSolver(PartBunch &bunch, string greensFuntion);

  FFTPoissonSolver(Mesh_t *mesh, FieldLayout_t *fl, string greensFunction);
...
private:    
  ...
  NDIndex<3> domain_m;             // original domain, gridsize defined in .mad (Nx,Ny,Nz)
