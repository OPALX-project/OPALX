...
*/
GreenWakeFunction::GreenWakeFunction(PartData &ref,  vector<OpalFilter*> filters, int NBIN, double Z0, double radius, double sigma, double c, double acMode, double tau, double direction, bool constLength):
  WakeFunction(ref),
