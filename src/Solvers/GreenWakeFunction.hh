...
class GreenWakeFunction:public WakeFunction
{
 public:
  ~GreenWakeFunction();
  GreenWakeFunction(PartData &reference,  vector<OpalFilter*> filters, int NBIN, double Z0, double radius, double sigma, double c, double acMode, double tau, double direction, bool constLength);
