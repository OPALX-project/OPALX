...
double FM1DProfile1::computeEntranceFringe(double z) {
    return computeFringe(engeCoeffsEntry_m, z / gapHeight_m);
}

double FM1DProfile1::computeExitFringe(double z) {
    return computeFringe(engeCoeffsExit_m, z / gapHeight_m);
}

double FM1DProfile1::computeFringe(const std::vector<double> &coefs, double z) {
