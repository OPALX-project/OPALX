...
void Beam::update()
{
  ...
  static const char *names[] = {
    "ELECTRON",   "PROTON",     "POSITRON",   "ANTIPROTON",  "CARBON", "HYDRONGEN_MINUS", "URANIUM"
  };

  static const double masses[] = {
      m_e, m_p, m_e, m_p, m_c, m_hm, m_u
  };

  static const double charges[] = {
      -1.0,         1.0,          1.0,          -1.0,     12.0,   -1.0, 35.0
  };
...
Inform &Beam::print(Inform &os) const
{
    ...
    os << "* BEAM        " << getOpalName() << '\n'
       ...
       << "* CHARGE      " << (charge > 0? '+':'-') << "e\n"
       << "* MASS        " << Attributes::getReal(itsAttr[MASS]) << " GeV\n"
