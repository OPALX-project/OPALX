...
class BoundaryGeometry: public Definition, public PriEmissionPhysics, public SecondaryEmissionPhysics {
...
public:
    ...
    vector<Vector_t>  GridIntersection(Vector_t x0, Vector_t x1);
    ...
    vector<string> getDistributionArray();
    ...
    void doFNemission(OpalBeamline &itsOpalBeamline, PartBunch *itsBunch, const double t);
