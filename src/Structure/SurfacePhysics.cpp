...
SurfacePhysics *SurfacePhysics::find(const string &name) {
    SurfacePhysics *sphys = dynamic_cast<SurfacePhysics *>(OPAL.find(name));
...
Inform &SurfacePhysics::print(Inform &os) const {
    os << "* ************* S U R F A C E P H Y S I C S **************************************** " << endl;
