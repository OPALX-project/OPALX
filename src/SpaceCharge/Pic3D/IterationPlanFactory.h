...
#ifndef OPALX_SPACE_CHARGE_PIC3D_ITERATION_PLAN_FACTORY_H
#define OPALX_SPACE_CHARGE_PIC3D_ITERATION_PLAN_FACTORY_H
...
#endif  // OPALX_SPACE_CHARGE_PIC3D_ITERATION_PLAN_FACTORY_H
