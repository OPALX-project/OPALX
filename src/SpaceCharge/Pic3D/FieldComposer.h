...
#ifndef OPALX_SPACE_CHARGE_PIC3D_FIELD_COMPOSER_H
#define OPALX_SPACE_CHARGE_PIC3D_FIELD_COMPOSER_H
...
#include "SpaceCharge/Pic3D/FieldComposer.tpp"

#endif  // OPALX_SPACE_CHARGE_PIC3D_FIELD_COMPOSER_H
