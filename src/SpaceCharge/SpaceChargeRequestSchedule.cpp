/**
 * @file SpaceChargeRequestSchedule.cpp
...
namespace opalx::spacecharge {
    ...
    SpaceChargeRequestSchedule::SpaceChargeRequestSchedule(const SpaceChargeConfig& config) {
        std::visit(
                [this](const auto& algorithmConfig) {
                    ...
                    if constexpr (std::is_same_v<Config, CartesianPICConfig>) {
                        ...
                        writePotential_m =
                                correction.kind() == SpaceChargeCorrectionType::ImageCharge
    ...
    SpaceChargeRequest SpaceChargeRequestSchedule::requestForStep(std::size_t step) const {
        SpaceChargeRequest requested;
        requested.useBinning = useBinning_m;
        const bool correctionActive =
                correction_m.kind != SpaceChargeCorrectionType::None
