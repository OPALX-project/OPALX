...
#ifndef OPALX_SPACE_CHARGE_PIC_SCATTER_GATHER_H
#define OPALX_SPACE_CHARGE_PIC_SCATTER_GATHER_H
...
#include "SpaceCharge/Pic/PicScatterGather.tpp"

#endif  // OPALX_SPACE_CHARGE_PIC_SCATTER_GATHER_H
