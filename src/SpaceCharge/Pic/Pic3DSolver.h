...
#ifndef OPALX_SPACE_CHARGE_PIC_PIC3D_SOLVER_H
#define OPALX_SPACE_CHARGE_PIC_PIC3D_SOLVER_H

#include "SpaceCharge/Pic/CorrectionPlan.h"
#include "SpaceCharge/Pic/FieldComposer.h"
#include "SpaceCharge/Pic/FieldFramePolicy.h"
...
namespace opalx::spacecharge {
     ...
     *
     * The solver borrows stable particle containers, the temporary backend facade, and a data
     * sink for its run lifetime. It never retains PartBunch, parser objects, per-call transforms,
     * or native Kokkos views. The common execute() boundary is always the tracker frame; the
     * private FieldFramePolicy owns the 3D beam-frame conversion and restoration contract.
     */
    ...
    public:
        ...
        using BackendFacade        = ::FieldSolver<double, 3>;
        ...
        Pic3DSolver(
                ...
                std::shared_ptr<Workspace> workspace, BackendFacade& backendFacade,
                DataSink* dataSink);
    ...
    private:
        ...
        BackendFacade* backendFacade_m = nullptr;
...
#endif  // OPALX_SPACE_CHARGE_PIC_PIC3D_SOLVER_H
