/**
 * @file ParticleMeshFieldTransfer.tpp
 * @brief Implements Cartesian PIC CIC deposition and gathering.
 */

#ifndef OPALX_SPACE_CHARGE_PARTICLE_MESH_FIELD_TRANSFER_TPP
#define OPALX_SPACE_CHARGE_PARTICLE_MESH_FIELD_TRANSFER_TPP
...
namespace opalx::spacecharge {
    ...
    void ParticleMeshFieldTransfer<T, Dim>::depositCharge(
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::gatherVector(
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::scatterScaledTimeStep(
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::applyImageTransform(
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::restoreImageTransform(
            ParticleContainer& particles, PositionAttribute& positions, const Selection& selection,
            double planeZ) const {
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::reflectPositions(
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::flipChargeSign(
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::validateSelection(
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::scatterCurrentWeights(
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::depositImage(
            ParticleContainer& particles, PositionAttribute& positions, ScalarField& rho,
    ...
    template <typename T, unsigned Dim>
    void ParticleMeshFieldTransfer<T, Dim>::normalizeChargeDensity(
...
#endif  // OPALX_SPACE_CHARGE_PARTICLE_MESH_FIELD_TRANSFER_TPP
