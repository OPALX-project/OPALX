...
namespace Expressions {
    ...
    template<> inline
    std::ostream &AValue<bool>::print(std::ostream &os) const {
        os << '{';
    ...
    template<> inline
    std::ostream &AValue<double>::print(std::ostream &os) const {
    ...
    template<> inline
    std::ostream &AValue<string>::print(std::ostream &os) const {
        os << '{';
    ...
    template<> inline
    std::ostream &AValue<std::list<Token> >::print(std::ostream &os) const {
        os << '{';
