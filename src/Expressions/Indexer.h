...
namespace Expressions {
  ...
  template <class T>
    ...
    public:
      ...
      /// Print expression.
      virtual std::ostream &print(std::ostream &str, int precedence=99) const;
  ...
  template <class T> inline
	...
	throw RangeError("Expressions::Indexer()", "Index out of range.");
      }
  ...
  template <class T> inline
    std::ostream &Indexer<T>::print(std::ostream &os, int precedence) const
    {
      lft->print(os, 0);
      os << '[';
      rgt->print(os, 0);
