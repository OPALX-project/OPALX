...
namespace Expressions {
    ...
    template <class T>
    std::ostream &SValue<T>::print(std::ostream &os) const {
        os << value;
        return os;
    }
    ...
    template<> inline
    std::ostream &SValue<std::list<Token> >::print(std::ostream &os) const {
    ...
    template<> inline
    std::ostream &SValue<bool>::print(std::ostream &os) const {
        os << (value ? "TRUE" : "FALSE");
        return os;
    }
    ...
    template<> inline
    std::ostream &SValue<string>::print(std::ostream &os) const {
        os << '"' << value << '"';
        return os;
    }
