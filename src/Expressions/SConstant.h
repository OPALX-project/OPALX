...
namespace Expressions {
  ...
  public:
    ...
    /// Print expression.
    virtual std::ostream &print(std::ostream &str, int precedence) const;
  ...
  template<> inline
  std::ostream &SConstant<bool>::print(std::ostream &os, int) const
    {
  ...
  template<> inline
  std::ostream &SConstant<double>::print(std::ostream &os, int) const
    {
  ...
  template<> inline
  std::ostream &SConstant<string>::print(std::ostream &os, int) const
    {
      return os << '"' << value << '"';
    }
  ...
  template<> inline
  std::ostream &
  SConstant<std::list<Token> >::print(std::ostream &os, int) const
    {
