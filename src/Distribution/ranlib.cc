...
// bit-identical to RANLUX values multiplied by 2^24.
//===================================================================
{
    ...
    while(ix[26] < 0) {
        ...
        ix[22] = ix[ 8] - ix[22];
        if(ix[23] < 0) {ix[23] += 16777216; --ix[22];}
        ix[21] = ix[ 7] - ix[21];
        if(ix[22] < 0) {ix[22] += 16777216; --ix[21];}
        ix[20] = ix[ 6] - ix[20];
        if(ix[21] < 0) {ix[21] += 16777216; --ix[20];}
        ix[19] = ix[ 5] - ix[19];
        if(ix[20] < 0) {ix[20] += 16777216; --ix[19];}
        ix[18] = ix[ 4] - ix[18];
        if(ix[19] < 0) {ix[19] += 16777216; --ix[18];}
        ix[17] = ix[ 3] - ix[17];
        if(ix[18] < 0) {ix[18] += 16777216; --ix[17];}
        ix[16] = ix[ 2] - ix[16];
        if(ix[17] < 0) {ix[17] += 16777216; --ix[16];}
        ix[15] = ix[ 1] - ix[15];
        if(ix[16] < 0) {ix[16] += 16777216; --ix[15];}
        ix[14] = ix[ 0] - ix[14];
        if(ix[15] < 0) {ix[15] += 16777216; --ix[14];}
        ix[13] = ix[23] - ix[13];
        if(ix[14] < 0) {ix[14] += 16777216; --ix[13];}
        ix[12] = ix[22] - ix[12];
        if(ix[13] < 0) {ix[13] += 16777216; --ix[12];}
        ix[11] = ix[21] - ix[11];
        if(ix[12] < 0) {ix[12] += 16777216; --ix[11];}
        ix[10] = ix[20] - ix[10];
        if(ix[11] < 0) {ix[11] += 16777216; --ix[10];}
        ix[ 9] = ix[19] - ix[ 9];
        if(ix[10] < 0) {ix[10] += 16777216; --ix[ 9];}
        ix[ 8] = ix[18] - ix[ 8];
        if(ix[ 9] < 0) {ix[ 9] += 16777216; --ix[ 8];}
        ix[ 7] = ix[17] - ix[ 7];
        if(ix[ 8] < 0) {ix[ 8] += 16777216; --ix[ 7];}
        ix[ 6] = ix[16] - ix[ 6];
        if(ix[ 7] < 0) {ix[ 7] += 16777216; --ix[ 6];}
        ix[ 5] = ix[15] - ix[ 5];
        if(ix[ 6] < 0) {ix[ 6] += 16777216; --ix[ 5];}
        ix[ 4] = ix[14] - ix[ 4];
        if(ix[ 5] < 0) {ix[ 5] += 16777216; --ix[ 4];}
        ix[ 3] = ix[13] - ix[ 3];
        if(ix[ 4] < 0) {ix[ 4] += 16777216; --ix[ 3];}
        ix[ 2] = ix[12] - ix[ 2];
        if(ix[ 3] < 0) {ix[ 3] += 16777216; --ix[ 2];}
        ix[ 1] = ix[11] - ix[ 1];
        if(ix[ 2] < 0) {ix[ 2] += 16777216; --ix[ 1];}
        ix[ 0] = ix[10] - ix[ 0];
        if(ix[ 1] < 0) {ix[ 1] += 16777216; --ix[ 0];}
        ix[24] = 0;
        if(ix[ 0] < 0) {ix[ 0] += 16777216; ++ix[24];}
        ix[26] += 24;
    }
...
{
    int    expo, fail;
    double sum = 0.0, x, y, sum0, sum1, sum2, fint, frac;
    //---------------------------------------------
