...
{
  itsAttr[DISTRIBUTION] = makeString("DISTRIBUTION", "Distribution type: GAUSS, BINOMIAL, ROTSYMBINOMIAL, FROMFILE, GUNGAUSS, GUNGAUSS3D, GUNUNIFORM, UNIFORMXYZ ", "GAUSS");
  ...
  itsAttr[T] = makeReal("T","avrage longitudinal position", 0.0);
...
void Distribution::create(PartBunch &beam, size_t Np) {
  ...
  if (disttype == "GUNGAUSS" || disttype == "GUNUNIFORM" || disttype == "GUNGAUSS3D") 
