...
namespace Attributes {
  ...
  extern Attribute makeBool(const string &name, const string &help);

  /// Make logical attribute.
  //  Initial value defined.
  extern Attribute 
  makeBool(const string &name, const string &help, bool initial);
  ...
  extern Attribute makeBoolArray(const string &name, const string &help);
  ...
  //  Initial value is "#S".
  extern Attribute makePlace(const string &name, const string &help);
  ...
  extern Attribute makeRange(const string &name, const string &help);
  ...
  extern Attribute
  makeReal(const string &name, const string &help);
  ...
  //  Initial value is empty array.
  extern Attribute makeRealArray(const string &name, const string &help);
  ...
  //  Initial value is undefined.
  extern Attribute makeReference(const string &name, const string &help);


  /// Make string attribute.
  //  Initial value undefined.
  extern Attribute makeString(const string &name, const string &help);
  ...
  /// Get string value.
  extern string getString(const Attribute &attr);

  /// Set string value.
  extern void setString(Attribute &attr, const string &val);


  /// Create a string array attribute.
  //  Initial value is empty array.
  extern Attribute makeStringArray(const string &name, const string &help);
  ...
  //  Initial value is undefined.
  extern Attribute makeTableRow(const string &name, const string &help);
  ...
  extern Attribute makeTokenList(const string &name, const string &help);
  ...
  /// Make token list attribute.
  //  Initial value is empty array.
  extern Attribute makeTokenListArray(const string &name, const string &help);
