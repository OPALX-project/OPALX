...
namespace Attributes {
    ...
    void Place::doomGet(Attribute &, const DoomReader &, int) const {
        // MISSING: Place::doomGet()
    }


    void Place::doomPut(const Attribute &, DoomWriter &, int) const {
        // MISSING: Place::doomPut()
    }
