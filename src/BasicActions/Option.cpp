	 ...
	 "The \"OPTION\" statement defines OPAL execution options.")
{
  ...
  itsAttr[AUTOPHASE] = Attributes::makeBool
    ("AUTOPHASE", "If true OPAL is scaning the phases of each rf structure in order to get maximum acceleration", autoPhase);
  ...
  Action(name, parent)
{
  ...
  Attributes::setBool(itsAttr[AUTOPHASE], autoPhase);
}
...
void Option::execute()
{
  ...
  autoPhase = Attributes::getBool(itsAttr[AUTOPHASE]);
