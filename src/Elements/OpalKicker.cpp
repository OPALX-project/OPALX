...
//BEGIN JMJ 14/12/2000 adding new print method by analogy with OpalSextupole.cc
// This is a block of new code

//void OpalKicker::print(std::ostream &os) const
//{
//  if (Options::mad8) {
...
////  Trying to remove the .getImage() from the next line to see if can avoid core dump
////    printAttribute(os, "HKICK", itsAttr[HKICK] , len);
////  That was no good, but the following seems to do the trick, except that we're
////  back to the :=
//    itsAttr[HKICK].print(os, len);
//    itsAttr[VKICK].print(os, len);
////
////  printAttribute(os, "VKICK", itsAttr[VKICK].getImage() , len);
...
//}
//
//END   JMJ 14/12/2000 adding new print method by analogy with OpalSextupole.cc
