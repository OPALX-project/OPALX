...
RealConstant::RealConstant():
    ...
    OPAL.create(new RealConstant("EMASS",  this, m_e));
    OPAL.create(new RealConstant("PMASS",  this, m_p));
    OPAL.create(new RealConstant("HMMASS", this, m_hm));
    OPAL.create(new RealConstant("UMASS", this, m_u));
    OPAL.create(new RealConstant("CMASS", this, m_c));
    OPAL.create(new RealConstant("MMASS", this, m_mu));
    OPAL.create(new RealConstant("DMASS", this, m_d));
    OPAL.create(new RealConstant("XEMASS", this, m_xe));

    OPAL.create(new RealConstant("CLIGHT", this, c));
}
