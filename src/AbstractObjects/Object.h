...
public:
  ...
  virtual Object *clone(const string &name) = 0;
  ...
  virtual Attribute *findAttribute(const string &name);

  /// Find an attribute by name.
  //  Find the Object's attribute identified by [b]name[/b]
  //  (version for constant object).
  virtual const Attribute *findAttribute(const string &name) const;
  ...
  /// Return object name.
  const string &getOpalName() const;
  ...
  /// Set object name.
  void setOpalName(const string &name);
...
protected:
  ...
  Object(const string &name, Object *parent);
