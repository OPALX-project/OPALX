 ...
 *
 * fprf.c   interface: print to buffered stream
 *
 * fprf( stream, format [, arg ] ... )
 *  FILE        *stream;
 *  char        *format;
 *
 ...
 *
 * Revision 1.2  89/04/15  17:59:37  heiner
...
static char rcsid[] =
    "$Header: /opt/csr/CVS/GUI/libprf/fprf.c,v 1.2 2005/07/18 12:32:57 birke Exp $";
#endif

void
fprf(FILE *stream, const char *format, ...) {
    va_list  ap;
    PrfDest  dest;
