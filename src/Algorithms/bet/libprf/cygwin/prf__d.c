 ...
 *
 * prf__d.c	support: main part of decimal conversion
 *
 * The alternate flag causes commas to be inserted for 3-digit blocks.
 * This may be used by "%d" and also "%g".
 *
 * $Log: prf__d.c,v $
...
static char rcsid[] =
	"$Header: /opt/csr/CVS/GUI/libprf/prf__d.c,v 1.2 2005/07/18 12:33:00 birke Exp $";
#endif
...
#define eobuf(b)	((b) + arrelems(b))
    ...
    void
prf__d( const PrfDest *dp, PrfSpec *psp, long val )
{
