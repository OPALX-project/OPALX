...
\end{tikzpicture}% End sketch output
  ...
  \caption{\label{rbendangle}
    Visualisation of angles used to rotate the bend relative to the incoming beam, where $\vec{n}$ is the normal of the face.
  }
  %
  \end{center}
%
...
%\label{sec:gun}
%\index{gun}
%The gun uses the defined distribution (Chapter \ref{sec:distribution}) and emits particles for a given duration (eventually defined
