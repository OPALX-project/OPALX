...
\item[REBINFREQ]
 \index{REBINFREQ}
   Defines after how many time steps we update the energy Bin ID of each particle. For the time being, this
   is only use for multi-bunch simulation in \opalcycl. Its default value is 100.  
