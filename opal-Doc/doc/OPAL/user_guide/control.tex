...
\index{AUTOPHASE}  
 ...
 the phases corresponding to the maximum energies is written. With this option only one \chpref{track}{track} can be executed, on one core. An example
 is \secref{given in}{trackautoph}.
