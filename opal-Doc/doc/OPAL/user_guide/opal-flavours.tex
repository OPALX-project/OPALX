...
Program reads in the median plane fields $B_z$ from a file in which the data is arranged in the format shown in Fig.\ref{fig:CYCLField}.
This function is originally for the field map of the PSI 450 MeV C12 cyclotron which is under design.
