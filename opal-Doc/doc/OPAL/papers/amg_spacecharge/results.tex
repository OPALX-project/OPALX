...
%The first test case consisted of a simulation within a cylindrical tube
%of radius $r=0.003$\,m.  The FFT-based and the PCG-AMG solver used a
%grid with $256^2\cdot128=8388608$ nodes.  The boundary conditions are
...
%of one step are given.  The PCG-AMG solver outperformed the FFT solver.
...
%\begin{table}[ht]
  %\begin{center}
    %\begin{tabular}{*{6}{c}}
      ...
      %\hline 
      %FFT & --- & --- & 8388608 & 25.4  \\
      %AMG & --- & constant & 8388608 & 10.7  \\
      %AMG & hierarchy & constant & 8388608 & 8.2  \\
      %AMG & preconditioner & constant & 8388608 &6.7  \\
      %\hline
    %\end{tabular}
