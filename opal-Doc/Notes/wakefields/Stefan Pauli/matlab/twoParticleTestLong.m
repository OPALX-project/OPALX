function [x deltaX] = twoParticleTestLong(t0, tend, dt,xStart,a, Direction, Csection, Material, Conductivity, Lbunch, Charge, K, c, wake)
% a fuction to calculate the force resulting form the two particle model
% with a longithudinal wake
% 
%Arguments:
...
[x deltaX] = leapFrog(t0, tend, dt, xStart, c*.9, @ddx, energy);
%plot(trajektorie);
end
