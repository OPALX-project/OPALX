function [x deltaX] = twoParticleTest(t0, tend, dt,xStart,a, Direction, Csection, Material, Conductivity, Lbunch, Charge, K, c, wake)
...
if strcmp(Direction, 'longitudinal')
    [x deltaX] = twoParticleTestLong(t0, tend, dt,xStart,a, Direction, Csection, Material, Conductivity, Lbunch, Charge, K, c,wake);
end
if strcmp(Direction, 'transversal')
    [x deltaX] = twoParticleTestTransversal(t0, tend, dt,xStart,a, Direction, Csection, Material, Conductivity, Lbunch, Charge, K, c,wake);
end
