...
rm -f Scan/*.T7
cd Scan
ln -s ../FIELDMAPS/OPAL/1T* .
cd ..

## Gun
rm -f Gun/OPAL/*.T7
ln -s ${PWD}/FIELDMAPS/OPAL/FINEG-MSL10.T7 Gun/OPAL/FINEG-MSL10.T7
ln -s ${PWD}/FIELDMAPS/OPAL/FINEG-ECAT.T7 Gun/OPAL/FINEG-ECAT.T7

cd Gun/ImpactT
rm -rf gun1MV-1
rm -rf gun1MV-2
./createGun gun1MV-1.cfg
./createGun gun1MV-2.cfg
cd ../../
...
ln -s ${PWD}/FIELDMAPS/OPAL/FIND1-MB01_nofringe.T7 Diagnostics/OPAL/FIND1-MB01_nofringe.T7
...
ln -s ${PWD}/FIELDMAPS/ImpactT/FIND1-MB01_nofringe Diagnostics/ImpactT/rfdata7
...
## Envelope test	
rm -rf envelope-test1/OPAL/*.T7
ln -s ${PWD}/FIELDMAPS/OPAL/FINEG-MSL10.T7 envelope-test1/OPAL/FINEG-MSL10.T7


## Wake
## ExternalFieldTest/NoSpaceCharge
rm -f Wake/OPAL/TwoStep.h5
rm -f Wake/OPAL/*.T7
ln -s ${PWD}/ExternalFieldTest/TwoStep.h5 Wake/OPAL/TwoStep.h5
ln -s ${PWD}/FIELDMAPS/OPAL/FINEG-MSL10.T7 Wake/OPAL/FINEG-MSL10.T7
ln -s ${PWD}/FIELDMAPS/OPAL/FINLB01-MSL.T7 Wake/OPAL/FINLB01-MSL.T7
ln -s ${PWD}/FIELDMAPS/OPAL/FINLB01-RACF.T7 Wake/OPAL/FINLB01-RACF.T7
ln -s ${PWD}/FIELDMAPS/OPAL/FINLB01-RACH.T7 Wake/OPAL/FINLB01-RACH.T7
ln -s ${PWD}/FIELDMAPS/OPAL/FINLB02-RAC.T7 Wake/OPAL/FINLB02-RAC.T7
ln -s ${PWD}/FIELDMAPS/OPAL/FINLB02-MSLAC.T7 Wake/OPAL/FINLB02-MSLAC.T7
