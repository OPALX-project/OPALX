...
NSLICES='390'     # number of emission slices (ImpactT only)
...
# create directories
    ...
    # (factor is ~1e6 larger than in IMPACTT - units?)
    VSCALE=str(-0.20456*v)
    
    # position for merging bins (10 mm after anode):
    #SMERGE=str(0.01*(float(GAP)+10.))
    #SMERGE=str(1000.0)
    # OPAL uses DEBIN (set to 1 keV in OBLAGun-OPAL.in)

    os.system('cp $OPAL_ROOT/opal-Tests/RegressionTests/Gun/Impact-t/input/OBLAGun-OPAL.in '+infile)
    ...
    os.system('ln -s /home5/schietinger/ImpactT/OBLA/magnet/OPAL/MSL10.T7 1T2.T7')
    os.system('ln -s /home5/schietinger/ImpactT/OBLA/magnet/OPAL/MSL20.T7 1T3.T7')
    ...
    infile='OBLAPostGun-OPAL.in'
    # caution: restart step hard-coded in run-rest depends on number of steps in gun...!!
    runscript='run-rest'

    os.system('cp $OPAL_ROOT/opal-Tests/RegressionTests/Gun/Impact-t/input/OBLAPostGun-OPAL.in '+infile)
    os.system('cp $OPAL_ROOT/opal-Tests/RegressionTests/Gun/Impact-t/input/run-rest '+runscript)
    os.system('mv Gun/OBLAGun-OPAL.h5 OBLAPostGun-OPAL.h5')
...
# create directories
    ...
    for i in range(1,nb+1):
        ...
        os.system('cp $OPAL_ROOT/opal-Tests/RegressionTests/Gun/Impact-t/input/OBLAGun.in '+infile)
    ...
    os.system('ln -s /home5/schietinger/ImpactT/OBLA/magnet/MSL10.T7 1T2.T7')
    os.system('ln -s /home5/schietinger/ImpactT/OBLA/magnet/MSL20.T7 1T3.T7')
    ...
    os.system('cp $OPAL_ROOT/opal-Tests/RegressionTests/Gun/Impact-t/input/OBLAPostGun.in '+infile)
