...
void C9B_7B_SB_Gamma_1mA(int Nstep=0, int NB1=1, int NB2=1){
  ...
  */
  ...
  TH1D* h1dX1 = data1->Histo1d("sqrt(1+px*px+py*py+pz*pz)", Nstep_SB, min1, max1, bins,"");
  TH1D* h1dX2 = data2->Histo1d("sqrt(1+px*px+py*py+pz*pz)", Nstep_MB1,min1, max1, bins,"");
  TH1D* h1dX3 = data3->Histo1d("sqrt(1+px*px+py*py+pz*pz)", Nstep_MB2, min1, max1, bins,"");
  delete dummy;
  //--------------plot--------------------//
  ...
  TString s1 = TString("C9B7BSB-Gamma-1mA-")+Nstep+".pdf";
  TString s2 = TString("C9B7BSB-Gamma-1mA-")+Nstep+".png";
