...
void C9B_7B_SB_2D_2mA(int Nstep=0,int NB1=1, int NB2=1){
  ...
  // load the data file:
  TH5Dataset *data1 = new TH5Dataset("Scenario-3/Ring-3.h5"); //1 bunch
  TH5Dataset *data2 = new TH5Dataset("Scenario-7/Ring-3.h5"); //7 bunches
  TH5Dataset *data3 = new TH5Dataset("Scenario-6/Ring-3.h5"); //9 bunches 
  ...
  double XminL=-0.05*1000.0;
  double XmaxL=0.05*1000.0;
  double YminL=-0.05*1000.0;
  double YmaxL=0.05*1000.0;
  ...
  TString s1 = TString("C9B7BSB-2D-2mA-")+Nstep+".pdf";
  TString s2 = TString("C9B7BSB-2D-2mA-")+Nstep+".png";
