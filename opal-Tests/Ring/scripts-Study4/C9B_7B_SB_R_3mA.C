...
void C9B_7B_SB_R_3mA(int Nstep=0, int NB1=1, int NB2=1){
  ...
  // load the data file:
  TH5Dataset *data1 = new TH5Dataset("Scenario-3/Ring-4.h5"); //1 bunch   
  TH5Dataset *data2 = new TH5Dataset("Scenario-7/Ring-4.h5"); //7 bunches 
  TH5Dataset *data3 = new TH5Dataset("Scenario-6/Ring-4.h5"); //9 bunches 
 ...
 // for convenience, get a dummy canvas for plotting
  ...
  TString s1 = TString("C9B7BSB-R-3mA-")+Nstep+".pdf";
  TString s2 = TString("C9B7BSB-R-3mA-")+Nstep+".png";
