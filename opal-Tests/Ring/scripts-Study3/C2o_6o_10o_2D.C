...
void C2o_6o_10o_2D(int Nstep=0){
  ...
  TLegend *legend3=new TLegend(0.65,0.85,0.85,.95);
  ...
  TLegend *legend4=new TLegend(0.65,0.85,0.85,0.95);
  ...
  gPad->SetBottomMargin(0.2);
    ...
    TLegend *legend5=new TLegend(0.6,0.85,0.85,0.95);
