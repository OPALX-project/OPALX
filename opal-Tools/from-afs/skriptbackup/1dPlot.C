...
myc->cd();
TH1F*  myFrame = myc->DrawFrame(0.005,1,0.03,4);
...
myc->cd();
legend->Draw();
TString ofn = TString("sigma-z-ratios")+TString(".pdf");
myc->Print(ofn);
myc->Update();
...
myc->cd();
legend->Draw();
TString ofn = TString("max-z-ratios")+TString(".pdf");
myc->Print(ofn);
myc->Update();
...
TCanvas* myc = new TCanvas("myc","  ",800,600);
myc->cd();
TH1F*  myFrame = myc->DrawFrame(0.005,0,0.03,4);
myFrame->SetXTitle("#sigma_{z-initial}");
...
myc->cd();
legend->Draw();
TString ofn = TString("sigma-x-ratios")+TString(".pdf");
myc->Print(ofn);
myc->Update();
...
myc->cd();
legend->Draw();
TString ofn = TString("max-x-ratios")+TString(".pdf");
myc->Print(ofn);
myc->Update();
}
