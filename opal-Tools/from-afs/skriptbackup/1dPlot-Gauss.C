...
myc->cd();
legend->Draw();
TString ofn = TString("sigma-z-ratios")+TString(".gauss.pdf");
myc->Print(ofn);
myc->Update();
...
myc->cd();
legend->Draw();
TString ofn = TString("max-z-ratios")+TString(".gauss.pdf");
myc->Print(ofn);
myc->Update();
...
myc->cd();
legend->Draw();
TString ofn = TString("sigma-x-ratios")+TString(".gauss.pdf");
myc->Print(ofn);
myc->Update();
...
myc->cd();
legend->Draw();
TString ofn = TString("max-x-ratios")+TString(".gauss.pdf");
myc->Print(ofn);
myc->Update();
}
