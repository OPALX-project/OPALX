...
def validateReferenceFiles(simname):
    ...
    if os.path.isfile(simname + ".stat") and \
       ...
       os.path.isfile(simname + ".lbal.md5"):
        ...
        allok = statout == simname + ".stat: OK" and \
                outout == simname + ".out: OK" and \
                lbalout == simname + ".lbal: OK"
...
def writeSgeFile(regtestname):
    ...
    sgefile += "#$ -v OPENMPI,LD_LIBRARY_PATH,OPAL_EXE_PATH,REG_TEST_DIR\n"
    sgefile += "\n"
...
def main(argv):
    ...
    if os.path.isfile(os.getenv("OPAL_EXE_PATH") + "/opal"):
        ...
        commands.getoutput("cp *.opal " + regtestname + "/")
        ...
        os.chdir(regtestname + "/reference")
        commands.getoutput("md5sum " + regtestname + ".out > " + regtestname + ".out.md5")
        commands.getoutput("md5sum " + regtestname + ".lbal > " + regtestname + ".lbal.md5")
        commands.getoutput("md5sum " + regtestname + ".stat > " + regtestname + ".stat.md5")
