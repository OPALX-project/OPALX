...
{
  if (r >= M  ||  c >= N) {
    throw RangeError("FArray2D::operator()", "Index out of range.");
  }
  return data[N*r+c];
}
...
{
  if (r >= M) {
    throw RangeError("FArray2D::row_begin()", "Row index out of range.");
  }
  return data + N * r;
}
...
{
  if (r >= M) {
    throw RangeError("FArray2D::row_end()", "Row index out of range.");
  }
  return data + N * (r + 1);
}
...
{
  if (c >= N) {
    throw RangeError("FArray2D::col_begin()", "Column index out of range.");
  }
...
{
  if (c >= N) {
    throw RangeError("FArray2D::col_end()", "Column index out of range.");
  }
