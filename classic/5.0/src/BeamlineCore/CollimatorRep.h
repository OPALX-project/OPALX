#ifndef CLASSIC_CollimatorRep_HH
#define CLASSIC_CollimatorRep_HH

// ------------------------------------------------------------------------
// $RCSfile: CollimatorRep.h,v $
// ------------------------------------------------------------------------
// $Revision: 1.1.1.1 $
// ------------------------------------------------------------------------
...
public:
    ...
    explicit CollimatorRep(const string &name);
    ...
    virtual Channel *getChannel(const string &aKey);
...
#endif // CLASSIC_CollimatorRep_HH
