...
public:
    ...
    GreenWakeFunction(const std::string &name, ElementBase* element, vector<Filter*> filters, int NBIN, double Z0, double radius, double sigma, double c, int acMode, double tau, int direction, bool constLength, string fname);
