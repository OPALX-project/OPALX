...
void PartBunch::boundp() {
    ...
    */
    ...
    if(~isGridFixed()) {
        ...
        get_bounds(rmin_m, rmax_m);
        len = rmax_m - rmin_m;
        //*gmsg<<"boundp rmax= "<<rmax_m<<" boundp rmin= "<<rmin_m<<endl;
        ...
        //*gmsg<<"boundp hr_m= "<<hr_m<<" boundp rmax= "<<rmax_m<<" boundp rmin= "<<rmin_m<<endl;
        // rescale mesh
        getMesh().set_meshSpacing(&(hr_m[0]));
        ...
        for(size_t particleNumber = 0; particleNumber < pbin_m->getLocalBinCount(binNumber); particleNumber++) {
            ...
            */
            ...
            if(itIsMyTurn(&pc)) {
                ...
                this->dt[numberOfEmittedParticles] =  getdT() - x(2);
