 ...
 */
  ...
  /** \brief emmit particles in the given bin
 ...
 */
  ...
  */    
  ...
  double getQ() { return reference->getQ();}
  double getM() { return reference->getM();}
  double getP() { return reference->getP();}
  double getE() { return reference->getE();}
  double getBeta() { return reference->getBeta();}
  double getGamma() { return reference->getGamma();}
