...
/**
This is only temporary in order to get the 
collimator and pepperpot workinh 
*/
  ...
  */
  ...
  inline double   get_sPos() { return sum(R(2))/getTotalNum();}
    ...
    inline double get_meanEnergy() const { return mean_energy_m; }
  ...
  void gatherLoadBalanceStatistics();
    ...
    inline void get_PBounds(Vector_t &max, Vector_t &min) const{ }
