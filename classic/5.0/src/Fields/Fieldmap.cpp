...
//           return (*position.first).second.Map;
        ...
        case T1DProfile1:
//           if (fast)
//             position = FieldmapDictionary.insert(pair<string,FieldmapDescription>(Filename,FieldmapDescription(T1DProfile1,new FM1DProfile1_fast(Filename))));
//           else
        ...
        case T1DProfile2:
//           if (fast)
//             position = FieldmapDictionary.insert(pair<string,FieldmapDescription>(Filename,FieldmapDescription(T1DProfile2,new FM1DProfile2_fast(Filename))));
//           else
...
//   return MapType(tmpInt);
  ...
  else if (tmpString == "1DProfile1")
    return T1DProfile1;
  else if (tmpString == "1DProfile2")
    return T1DProfile2;
