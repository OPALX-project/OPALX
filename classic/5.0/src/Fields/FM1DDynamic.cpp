  ...
  if (file.good())
    {
      ...
      double periodLengthFromFrequency = c / (frequency_m * 1.0e6);
      ...
      // Test that field map dimensions match given frequency.
      double periodLengthFromMap = (zend_m - zbegin_m) / 2.0;
      if ((periodLengthFromFrequency - periodLengthFromMap) / periodLengthFromMap > 0.0001) {
    	  msg << "* ************** W A R N I N G *****************************************************" << endl;
    	  msg << "* DIMENSIONS OF FIELD MAP IN \"" << Filename_m << "\" DO NOT MATCH THE FREQUENCY" <<endl;
    	  msg << "* RECALCULATING FIELD LENGTH TO MATCH FREQUENCY" << endl;
    	  msg << "* **********************************************************************************" << endl;
    	  zend_m = zbegin_m + 2.0 * periodLengthFromFrequency;
      }
