...
Astra1DElectroStatic::Astra1DElectroStatic(string aFilename)
    : Fieldmap(aFilename),
      FourCoefs_m(NULL) {
    Inform msg("*1DES ");
    ifstream file;
...
bool Astra1DElectroStatic::getFieldstrength_fdiff(const Vector_t &R, Vector_t &E, Vector_t &B, const DiffDirection &dir) const
{ }
