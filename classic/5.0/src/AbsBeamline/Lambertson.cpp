...
bool Lambertson::apply(const Vector_t &R, const double &t, Vector_t &E, Vector_t &B)
{
    return false;
}

void Lambertson::initialise(const PartBunch *bunch, double &startField, double &endField, const double &scaleFactor)
{
...
void Lambertson::rescaleFieldMap(const double &scaleFactor)
{ }
