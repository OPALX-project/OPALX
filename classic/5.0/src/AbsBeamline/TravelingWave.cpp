...
bool TravelingWave::apply(const int &i, const double &t, Vector_t &E, Vector_t &B)
{
  ...
  Vector_t tmpR(RefPartBunch_m->R[i](0),RefPartBunch_m->R[i](1),RefPartBunch_m->R[i](2) - startField_m);
...
bool TravelingWave::apply( const Vector_t &R, const double &t, Vector_t &E, Vector_t &B)
{
  double tmpcos, tmpsin;
