...
bool RFCavity::readFieldMap(double &startField, double &endField, double scaleFactor)
{
...
void RFCavity::rescaleFieldMap(double scaleFactor)
{
...
bool RFCavity::getFieldstrength(double R[], double t, double E[], double B[]) const
{
...
bool RFCavity::getFieldstrength(Vector_t R, double t, Vector_t &E, Vector_t &B) const
{
  using Physics::two_pi;
  using Physics::mu_0;
  using Physics::c;

  double tmpcos =  scale_m * cos( frequency_m * t + phase_m );
  double tmpsin = -scale_m * sin( frequency_m * t + phase_m );
...
void RFCavity::readFieldMap(double scaleFactor)
{
  using Physics::pi;
