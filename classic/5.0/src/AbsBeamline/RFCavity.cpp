...
double RFCavity::derivative(double z, double t) {
    ...
    msg << "Accuracy criteria for derivative not met: Error = " << tmpEr << " (>" << error << ")" << endl;
    return dnew;
}
...
void RFCavity::addKR(int i, double t, Vector_t &K) {
    ...
    double wtf = frequency_m * t + phase_m; // Physics::two_pi;
