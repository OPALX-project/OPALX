...
public:
    ...
    virtual bool apply(const Vector_t &R, const double &t, Vector_t &E, Vector_t &B) = 0;
  
    virtual void initialise(const PartBunch *bunch, double &startField, double &endField, const double &scaleFactor) = 0;

    virtual void initialise(const PartBunch *bunch, const double &scaleFactor);
  
    virtual void initialise(const PartBunch *bunch, const int &fieldflag, const double &scaleFactor);

    virtual void finalise() = 0;

    virtual void rescaleFieldMap(const double &scaleFactor) = 0;
    ...
    const Vector_t getOrientation() const;  // first component is alpha, second is beta. the third component is always neglected.
...
protected:
    ...
    const PartBunch *RefPartBunch_m;
    bool online_m;
};
...
inline const Vector_t Component::getOrientation() const
