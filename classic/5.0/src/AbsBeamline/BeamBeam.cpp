...
bool BeamBeam::apply(const Vector_t &R, const double &t, Vector_t &E, Vector_t &B)
{
  return false;
}

void BeamBeam::initialise(const PartBunch *bunch, double &startField, double &endField, const double &scaleFactor)
{
...
void BeamBeam::rescaleFieldMap(const double &scaleFactor)
{}
