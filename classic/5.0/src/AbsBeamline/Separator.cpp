...
bool Separator::apply(const Vector_t &R, const double &t, Vector_t &E, Vector_t &B)
{
  return false;
}

void Separator::initialise(const PartBunch *bunch, double &startField, double &endField, const double &scaleFactor)
{
...
void Separator::rescaleFieldMap(const double &scaleFactor)
{}
