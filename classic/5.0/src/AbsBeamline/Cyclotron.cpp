...
void Cyclotron::initialise(const PartBunch *bunch, const double &scaleFactor)
{
  RefPartBunch_m = bunch;

  // for your own format field, you should add your own getFieldFromFile() function by yourself. 
  
  // read magnetic field data from PSI format file.
  getFieldFromFile(scaleFactor);

  //  read magnetic field for Carbon cycltron. 
