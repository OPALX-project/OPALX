...
bool Cyclotron::getFieldstrength( Vector_t R, double t, Vector_t &E, Vector_t &B) const
{
  ...
  // the corresponding angle one the field map 
...
void Cyclotron::getFieldFromFile( double scaleFactor)
{	
...
void Cyclotron::readFieldMap(double scaleFactor)
{


  // read magnet-field data from external file.
