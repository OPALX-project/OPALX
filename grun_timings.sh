...
srun --ntasks=1 ./BinningLandauDamping 32 32 32 100000000 20 FFT 0.01 LeapFrog --overallocate 2.0 --info 10 
srun --ntasks=2 ./BinningLandauDamping 32 32 32 100000000 20 FFT 0.01 LeapFrog --overallocate 2.0 --info 10 
srun --ntasks=4 ./BinningLandauDamping 32 32 32 100000000 20 FFT 0.01 LeapFrog --overallocate 2.0 --info 10 
srun --ntasks=8 ./BinningLandauDamping 32 32 32 100000000 20 FFT 0.01 LeapFrog --overallocate 2.0 --info 10 
