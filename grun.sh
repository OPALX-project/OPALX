...
cd /data/user/liemen_a/build_ippl/
cmake ../ippl/ -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_STANDARD=20 -DIPPL_PLATFORMS="OPENMP;CUDA" -DKokkos_ARCH_AMPERE80=ON -DENABLE_TESTS=on -DENABLE_SOLVERS=OFF -DENABLE_FFT=OFF -DONLY_BINNING=ON
make -j $(nproc)
